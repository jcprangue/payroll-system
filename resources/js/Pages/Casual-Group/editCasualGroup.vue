...
export default {
    ...
    watch:{
        'group':function(val){
            this.form.name = val.group_name;
            this.form.type = val.payroll_type;
            this.form.department_charging_id = val.department_charging_id;
        }
    },
    mounted() {
        this.form.name = this.group.group_name;
        this.form.type = this.group.payroll_type;
        this.form.department_charging_id = this.group.department_charging_id;
    },
    methods: {
        close() {
        ...
        submit() {
            ...
            // this.form.name = ''
            // this.form.type = ''
            // this.form.department_charging_id = '';
